...
const client = global.client = new Client({	allowedMentions: { parse: ['users', 'roles', 'guild'], repliedUser: true },  intents: [
...
client.login(set.macro.macronunemaneti).catch(err => {console.error("Discord API Tokeni doğrulamadi")});
